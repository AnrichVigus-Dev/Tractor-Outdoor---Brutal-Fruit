...
//Query User mysql_list_tables
  ...
  if ($_GET['orderby'] == 0) {
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM `tractorusers` WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' ORDER BY id DESC");
  }
  else if ($_GET['orderby'] == 1) {
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM `tractorusers` WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' ORDER BY id DESC");
  }
  else if ($_GET['orderby'] == 2) {
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM `tractorusers` WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' ORDER BY id ASC");
  }
  else if ($_GET['orderby'] == 3) {
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM `tractorusers` WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '0' ORDER BY id DESC ");
  }
  else if ($_GET['orderby'] == 4) {
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM `tractorusers` WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '0' ORDER BY id ASC");
  }
  else if ($_GET['orderby'] == 5) {
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM `tractorusers` WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '1' ORDER BY id ASC");
  }
  else if ($_GET['orderby'] == 6) {
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM `tractorusers` WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '1' ORDER BY id DESC");
  }
  else if ($_GET['orderby'] == 7) {
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM `tractorusers` WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '2' ORDER BY id ASC");
  }
  else if ($_GET['orderby'] == 8) {
	$result_count = mysqli_query($link,"SELECT COUNT(*) As total_records FROM `tractorusers` WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '2' ORDER BY id DESC");
  }
...
if ($_GET['orderby'] == 0) {
$sqluser = "SELECT * FROM tractorusers WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' ORDER BY id DESC LIMIT $offset, $total_records_per_page";
}
else if ($_GET['orderby'] == 1) {
$sqluser = "SELECT * FROM tractorusers WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' ORDER BY id DESC LIMIT $offset, $total_records_per_page";
}
else if ($_GET['orderby'] == 2) {
$sqluser = "SELECT * FROM tractorusers WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' ORDER BY id ASC LIMIT $offset, $total_records_per_page";
}
else if ($_GET['orderby'] == 3) {
$sqluser = "SELECT * FROM tractorusers WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '0' ORDER BY id DESC LIMIT $offset, $total_records_per_page";
}
else if ($_GET['orderby'] == 4) {
$sqluser = "SELECT * FROM tractorusers WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '0' ORDER BY id ASC LIMIT $offset, $total_records_per_page";
}
else if ($_GET['orderby'] == 5) {
$sqluser = "SELECT * FROM tractorusers WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '1' ORDER BY id ASC LIMIT $offset, $total_records_per_page";
}
else if ($_GET['orderby'] == 6) {
$sqluser = "SELECT * FROM tractorusers WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '1' ORDER BY id DESC LIMIT $offset, $total_records_per_page";
}
else if ($_GET['orderby'] == 7) {
$sqluser = "SELECT * FROM tractorusers WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '2' ORDER BY id ASC LIMIT $offset, $total_records_per_page";
}
else if ($_GET['orderby'] == 8) {
$sqluser = "SELECT * FROM tractorusers WHERE (idlocation != 0 AND idbillboard != 0) AND idcampaign = '$idcampaign' AND status = '2' ORDER BY id DESC LIMIT $offset, $total_records_per_page";
}
